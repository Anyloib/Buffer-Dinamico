...
namespace Efectos
{
    class Delay : ISampleProvider
    {
        ...
        private int cantidadMuestrasTrancurridas = 0;
        ...
        public Delay(ISampleProvider fuente)
        {
            ...
            tamañoBuffer = 28 * fuente.WaveFormat.SampleRate;
        ...
        public int Read(float[] buffer, int offset, int count)
        {
            ...
            float tiempoTranscurrido =
               (float) cantidadMuestrasTrancurridas / (float)fuente.WaveFormat.SampleRate;
            ...
            if ( tiempoTranscurridoMS > offsetTiempoMS)
            {
                for (int i = 0; i < read; i++)
                {
                    ...
                    buffer[i] +=
                        muestras[(cantidadMuestrasTrancurridas - cantidadMuestrasBorradas)+
